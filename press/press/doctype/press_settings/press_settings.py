...
class PressSettings(Document):
	...
	if TYPE_CHECKING:
		...
		anthropic_custom_headers_json: DF.JSON | None
		anthropic_default_haiku_model: DF.Data | None
		anthropic_default_model: DF.Data | None
		anthropic_default_opus_model: DF.Data | None
		anthropic_default_sonnet_model: DF.Data | None
